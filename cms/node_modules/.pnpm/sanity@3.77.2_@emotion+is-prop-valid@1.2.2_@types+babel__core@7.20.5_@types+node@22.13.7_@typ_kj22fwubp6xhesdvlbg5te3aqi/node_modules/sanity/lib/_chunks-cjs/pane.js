...
function AddToReleaseBanner(t0) {
  ...
  let t6;
  $[12] !== currentRelease ? (t6 = sanity.getVersionInlineBadge(currentRelease), $[12] = currentRelease, $[13] = t6) : t6 = $[13];
  let t7;
  $[14] !== t6 ? (t7 = {
    VersionBadge: t6
  }, $[14] = t6, $[15] = t7) : t7 = $[15];
  let t8;
  $[16] !== t || $[17] !== t5 || $[18] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { i18nKey: "banners.release.not-in-release", t, values: t5, components: t7 }) }), $[16] = t, $[17] = t5, $[18] = t7, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== t ? (t9 = t("banners.release.action.add-to-release"), $[20] = t, $[21] = t9) : t9 = $[21];
  let t10;
  $[22] !== handleAddToRelease || $[23] !== t9 || $[24] !== tone ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { text: t9, tone, onClick: handleAddToRelease }), $[22] = handleAddToRelease, $[23] = t9, $[24] = tone, $[25] = t10) : t10 = $[25];
  let t11;
  $[26] !== t10 || $[27] !== t8 ? (t11 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: [
    t8,
    t10
  ] }), $[26] = t10, $[27] = t8, $[28] = t11) : t11 = $[28];
  let t12;
  return $[29] !== t11 || $[30] !== tone ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone, paddingY: 0, content: t11 }), $[29] = t11, $[30] = tone, $[31] = t12) : t12 = $[31], t12;
}
...
const DocumentPaneProvider = React.memo((props) => {
  ...
  }), isCreateLinked = sanity.isSanityCreateLinkedDocument(value), isNonExistent = !value?._id, willBeUnpublished = sanity.isGoingToUnpublish(value), readOnly = React.useMemo(() => {
  ...
  }, [editState.draft, editState.published, initialValue.value, patch, telemetry2, readOnly, isCreateLinked]);
