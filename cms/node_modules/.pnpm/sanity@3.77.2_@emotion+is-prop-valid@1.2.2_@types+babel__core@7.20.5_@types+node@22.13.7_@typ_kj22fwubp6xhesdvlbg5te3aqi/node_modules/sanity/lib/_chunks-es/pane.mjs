...
function AddToReleaseBanner(t0) {
  ...
  let t8;
  $[16] !== t || $[17] !== t5 || $[18] !== t7 ? (t8 = /* @__PURE__ */ jsx(Text, { size: 1, children: /* @__PURE__ */ jsx(Translate, { i18nKey: "banners.release.not-in-release", t, values: t5, components: t7 }) }), $[16] = t, $[17] = t5, $[18] = t7, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== t ? (t9 = t("banners.release.action.add-to-release"), $[20] = t, $[21] = t9) : t9 = $[21];
  let t10;
  $[22] !== handleAddToRelease || $[23] !== t9 || $[24] !== tone ? (t10 = /* @__PURE__ */ jsx(Button, { text: t9, tone, onClick: handleAddToRelease }), $[22] = handleAddToRelease, $[23] = t9, $[24] = tone, $[25] = t10) : t10 = $[25];
  let t11;
  $[26] !== t10 || $[27] !== t8 ? (t11 = /* @__PURE__ */ jsxs(Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: [
    t8,
    t10
  ] }), $[26] = t10, $[27] = t8, $[28] = t11) : t11 = $[28];
  let t12;
  return $[29] !== t11 || $[30] !== tone ? (t12 = /* @__PURE__ */ jsx(Banner, { tone, paddingY: 0, content: t11 }), $[29] = t11, $[30] = tone, $[31] = t12) : t12 = $[31], t12;
}
...
const preventDefault = (ev) => ev.preventDefault(), FormView = forwardRef(function(props, ref) {
  ...
  let t16;
  return $[70] !== hidden || $[71] !== t15 ? (t16 = /* @__PURE__ */ jsx(Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[70] = hidden, $[71] = t15, $[72] = t16) : t16 = $[72], t16;
});
...
const DocumentPaneProvider = memo((props) => {
  ...
  const currentInspector = inspectors2?.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), changesOpen = currentInspector?.name === HISTORY_INSPECTOR_NAME, {
  ...
  }), isCreateLinked = isSanityCreateLinkedDocument(value), isNonExistent = !value?._id, willBeUnpublished = isGoingToUnpublish(value), readOnly = useMemo(() => {
    ...
    return liveEdit && editState.draft?._id || !liveEdit && selectedPerspectiveName === "published" || selectedReleaseId && getVersionFromId(value._id) !== selectedReleaseId ? !0 : willBeUnpublished || !ready || revisionId !== null || hasNoPermission || updateActionDisabled || createActionDisabled || reconnecting || isLocked || isDeleting || isDeleted || isCreateLinked || isReleaseLocked;
  }, [isPermissionsLoading, permissions?.granted, schemaType, isNonExistent, connectionState, editState.transactionSyncLock?.enabled, editState.draft?._id, liveEdit, selectedPerspectiveName, selectedReleaseId, value._id, willBeUnpublished, ready, revisionId, isDeleting, isDeleted, isCreateLinked, isReleaseLocked]), patchRef = useRef(() => {
