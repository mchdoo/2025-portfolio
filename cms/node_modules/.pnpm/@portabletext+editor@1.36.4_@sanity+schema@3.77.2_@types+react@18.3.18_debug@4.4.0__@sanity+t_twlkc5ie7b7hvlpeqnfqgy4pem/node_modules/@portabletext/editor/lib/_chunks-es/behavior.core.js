...
const arrowDownOnLonelyBlockObject = {
  ...
  guard: ({
    ...
    const isArrowDown = isHotkey("ArrowDown", event.keyboardEvent), focusBlockObject = getFocusBlockObject(snapshot), nextBlock = getNextBlock(snapshot);
  ...
  guard: ({
    ...
    const isArrowUp = isHotkey("ArrowUp", event.keyboardEvent), focusBlockObject = getFocusBlockObject(snapshot), previousBlock = getPreviousBlock(snapshot);
